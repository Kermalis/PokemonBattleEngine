...
namespace Kermalis.PokemonBattleEngineMobile.Views
{
    ...
    public partial class ActionsView : ContentView
    {
        ...
        {
            Pokemon = pkmn;
            Party = Pokemon.Team.Party.Select(p => new PokemonInfo(p, Pokemon.TempLockedMove != PBEMove.None || BattleView.Client.StandBy.Contains(p), SelectPokemonForTurn)).ToArray();
