...
namespace Kermalis.PokemonBattleEngine.Battle
{
    public sealed partial class PBEBattle
    {
        ...
        private void BroadcastEffectiveness(PBEPokemon victim, PBEEffectiveness effectiveness)
        {
            var p = new PBEMoveEffectivenessPacket(victim, effectiveness);
            Events.Add(p);
            OnNewEvent?.Invoke(this, p);
        }
        private void BroadcastMoveFailed(PBEPokemon moveUser, PBEPokemon pokemon2, PBEFailReason failReason)
        {
